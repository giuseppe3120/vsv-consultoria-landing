...
export default function Testimonials() {
  ...
  return (
    <section id="depoimentos" className="py-24" ref={ref}>
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="scroll-reveal rounded-xl border border-primary/8 bg-card p-7 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/5"
              data-stagger={i + 2}
            >
        ...
        <div className="scroll-reveal mt-12 text-center" data-stagger="5">
          <a
            href={WHATSAPP_URL}
            target="_blank"
